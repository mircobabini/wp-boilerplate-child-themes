...
$WP_THUMB_PATH = untrailingslashit( dirname( __FILE__ ) );
define( 'WP_THUMB_PATH', $WP_THUMB_PATH );
$WP_THUMB_URL = str_replace( ABSPATH, site_url(), $WP_THUMB_PATH );
define( 'WP_THUMB_URL', $WP_THUMB_URL );


var_dump( 'wpthumb.php in plugins fake dir', $WP_THUMB_PATH, $WP_THUMB_URL ); die;
